...
void UUIPanelPlayerFPS::ChangeInteractable(E_INTERACT_TYPE InteractType)
{
	...
	else
	{
		...
		FString _texturePath = ConstantLibrary::Resource.Image.INTERACT_FOLDER_PATH + CommonEnums::GetFStringInteractEnum(InteractType) + "." + CommonEnums::GetFStringInteractEnum(InteractType);
